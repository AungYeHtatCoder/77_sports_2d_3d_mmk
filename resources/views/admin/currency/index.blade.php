  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-header pb-0">
        <div class="d-lg-flex">
          <div>
            <h5 class="mb-0">Currency Dashboards</h5>

          </div>
          <div class="ms-auto my-auto mt-lg-0 mt-4">
            <div class="ms-auto my-auto">
              <a href="{{ route('admin.currency.create') }}" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; New Currency</a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <form class="d-inline" action="{{ route('admin.currency.destroy', $currency->id) }}" method="POST">
                  @csrf
                  @method('DELETE')
