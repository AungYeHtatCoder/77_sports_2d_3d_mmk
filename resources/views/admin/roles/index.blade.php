 ...
 <div class="col-12">
  <div class="card">
   ...
   <div class="card-header pb-0">
    <div class="d-lg-flex">
     <div>
      <h5 class="mb-0">User's Role Dashboards</h5>
    ...
    <table class="table table-flush" id="roles-search">
     ...
     <tbody>
      ...
      <tr>
       ...
       <td class="text-sm font-weight-normal">{{ $role->title }}</td>
       <td class="text-sm font-weight-normal">{{ $role->created_at->format('F j, Y') }}</td>
       <td class="text-sm font-weight-normal">{{ $role->updated_at->format('F j, Y') }}</td>
       <td>
        <a href="{{ route('admin.roles.edit', $role->id) }}" data-bs-toggle="tooltip"
         data-bs-original-title="Edit Role"><i
          class="material-icons-round text-secondary position-relative text-lg">mode_edit</i></a>
        <a href="{{ route('admin.roles.show', $role->id) }}" data-bs-toggle="tooltip"
         data-bs-original-title="Preview Role Detail">
