...
<div class="my-3">
  <div class="d-flex justify-content-around align-items-center">
    ...
    <select name="time_options" id="exampleSelect" class="px-3 py-1 rounded border border-none">
      <option value="12:00PM">9:30AM</option>
      <option value="12:00PM">12:00PM</option>
      <option value="2:30AM">2:30AM</option>
      <option value="4:00PM" selected>4:00PM</option>
    </select>
  </div>
</div>
...
<div class="d-flex justify-content-center align-items-center mt-3" style="font-size: 16px">
  <div class="px-4" style="width: 100%">
    ...
    <button type="button" class="btn permutebtn my-2" style="
              display: flex;
              width: 100%;
              height: 45px;
              padding: 10px;
...
<footer class="fixed-bottom bg-white py-3 mx-auto">
  <div class="row">
    ...
    <div class="col">
      <a href="{{ route('user.twod-play-confirm-4pm') }}" style="
                display: flex;
                padding: 10px;
                justify-content: center;
                align-items: center;
