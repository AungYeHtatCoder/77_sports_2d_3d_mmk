  ...
  <div class="col-lg-4 col-md-4 offset-lg-4 offset-md-4 mt-5 py-4" style="background-color: #ffffff;">
    ...
    <div>
      <div class="d-flex justify-content-between custom-btn">
        ...
        <a href="{{ url('/user/two-d-quick-play-index') }}" class="btn h-50 text-white" style="background-color: #2a576c; font-size:14px;">အမြန်ရွေး</a>
        <div class="">
          <h1>2D</h1>
        </div>
          ...
          <form action="{{ route('admin.two-d-play.store') }}" method="post" class="p-1">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 offset-lg-4 offset-md-3 py-3 submitbtns">
                ...
                ">
                  <a href="{{ url('/user/two-d-play-index-simple') }}" class="btn remove-btn me-2">ဖျက်မည်</a>
                  <a href="{{ url('/user/two-d-play-9-30-early-morning-confirm') }}" onclick="storeSelectionsInLocalStorage()" class="btn play-btn">ထိုးမည်</a>
                </div>
              </div>
            </div>
          </form>
