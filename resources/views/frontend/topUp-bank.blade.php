...
<div class="my-3 px-3">
  ...
  {{-- <div class="d-flex justify-content-center align-items-center">
    <a href="{{ route('topup') }}" class="text-decoration-none"><img src="{{ asset('user_app/assets/img/kpay.png') }}" class="px-2 m-2" alt="" /></a>
    <a href="{{ route('topup') }}" class="text-decoration-none"><img src="{{ asset('user_app/assets/img/aya.png') }}" class="px-2 m-2" alt="" /></a>
  </div>
  <div class="d-flex justify-content-center align-items-center">
    <a href="{{ route('topup') }}" class="text-decoration-none"><img src="{{ asset('user_app/assets/img/wave.png') }}" class="px-2 m-2" alt="" /></a>
    <a href="{{ route('topup') }}" class="text-decoration-none"><img src="{{ asset('user_app/assets/img/cb.png') }}" class="px-2 m-2" alt="" /></a>
  </div> --}}
</div>
