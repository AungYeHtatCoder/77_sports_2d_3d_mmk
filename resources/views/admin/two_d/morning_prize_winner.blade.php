    ...
    <div class="col-12">
         ...
         <div class="card mt-3">
            ...
            <div class="card-header pb-0">
                <div>
                    <h5 class="mb-0">2D မနက်ပိုင်း ပေါက်သူများ
                ...
                <div class="card-header pb-0">
                 <form action="{{ route('admin.PostMorningPrizeWinners') }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-primary">2D မနက်ပိုင်း ပေါက်သူများသိမ်းရန်</button>
                    </form>
                </div>
        ...
        <div class="card mt-2">
         <div class="card-header">
          <h5>2D မနက်ပိုင်း ပေါက်သူများ</h5>
         </div>
          <div class="table-responsive">
                <table class="table table-flush" id="twod-search">
                    <thead class="thead-light">
