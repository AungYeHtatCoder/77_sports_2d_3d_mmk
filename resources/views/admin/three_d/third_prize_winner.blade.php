    ...
    <div class="col-12">
         ...
         <div class="card mt-3">
            ...
            <div class="card-header pb-0">
                <div>
                    <h5 class="mb-0">3D သွပ်ပေါက်သူများ
                    
                    </h5>
                </div>
                <div class="card-header pb-0">
                 <form action="{{ route('admin.PostThirdPrizeWinners') }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-primary">3D သွပ်ပေါက်သူများသိမ်းရန်</button>
                    </form>
                </div>
                <div class="d-lg-flex mt-2">
                    <div class="ms-auto my-auto mt-lg-0">
                        <div class="ms-auto my-auto">
                        <form action="{{ route('admin.updateThirdwinners') }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-primary">3D Third Winner Update</button>
                    </form>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-flush" id="twod-search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            @if($winner->prize_sent == 3)
                                <span class="badge badge-primary">သွပ်ရရှိသည်</span>
                            @else
        ...
        <div class="card mt-2">
         <div class="card-header">
          <h5>3D Third Prize Winner History</h5>
         </div>
          <div class="table-responsive">
                <table class="table table-flush" id="twod-search">
                    <thead class="thead-light">
