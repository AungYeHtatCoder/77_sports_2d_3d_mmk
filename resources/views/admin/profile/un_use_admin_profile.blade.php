            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="card mt-5">
                 <div class="card-header">
                  <h5>ငွေလက်ခံမည့်ဖုန်းနံပါတ်များထဲ့ရန်</h5>
                 </div>
     ...
     <!-- <div class="col-sm-auto ms-sm-auto mt-sm-0 mt-3 d-flex">
      <a class="btn btn-icon btn-3 btn-primary" href="{{ url('/admin/profile/fill_money') }}">
                                    ...
                                    <div class="row mt-3">
                                        <div class="input-group input-group-static">
                                            <label>CB Pay</label>
                                            <input type="text" name="cbpay_no" class="form-control" value="{{ Auth::user()->cbpay_no }}">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="input-group input-group-static">
                                    ...
                                    <div class="row mt-3">
                                        <div class="input-group input-group-static">
                                            <label>AYA Pay</label>
                                            <input type="text" name="ayapay_no" class="form-control"
                                               value="{{ Auth::user()->ayapay_no }}">
                                        </div>
                                    </div>
                                </div>
                                <div class=" mt-1 mb-3 me-4">
                                    <button type="submit" class="btn bg-gradient-dark btn-sm float-end">Update Payment Number
                                    </button>
                                </div>
                            </form>
            ...
            <div class="col-lg-9 mt-lg-0 mt-4">
                ...
                <div class="card card-body" id="profile">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-sm-auto col-4">
                            <div class="avatar avatar-xl position-relative">
                                <img src="{{ asset('admin_app/assets/img/team-3.jpg') }}" alt="bruce"
                        ...
                        <div class="card mt-4" id="password">
                            ...
                            <form action="{{ route('admin.changePassword', Auth::user()->id) }}" method="post">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <button type="submit" class="btn bg-gradient-dark btn-sm float-end mb-0">Update
                                        password</button>
