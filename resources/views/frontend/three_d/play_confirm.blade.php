...
<form action="{{ route('user.three-d-choice-play-store') }}" method="POST" class="pt-5 mt-5">
  @csrf
  <div class="row mx-2">
    <div class="" style="padding-bottom:100px;">
      <div>
        ...
        <div class="d-flex justify-content-between">
          ...
          <div class="">
            <a href="{{ route('user.three-d-choice-play') }}" class="btn btn-sm btn-danger me-2" style="font-size: 14px;">ဖျက်မည်</a>
            <button type="submit" class="btn btn-sm btn-primary text-dark me-1" style="font-size: 14px;">ထိုးမည်</button>
          </div>
        </div>
      </div>
    </div>
    ...
    Object.entries(selections).forEach(([digit, amount], index) => {
      ...
      <td>
        <div class="d-flex justify-content-center">
          <a href="#" onclick="editDigit('${digit}'); return false;"><i class="fa-regular text-primary fa-pen-to-square mx-3"></i></a>
