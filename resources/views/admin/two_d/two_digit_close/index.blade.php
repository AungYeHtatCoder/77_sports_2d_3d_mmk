 ...
 <div class="col-12">
  <div class="card">
   ...
   <div class="card-header pb-0">
    <div class="d-lg-flex">
     <div>
      <h5 class="mb-0">စိတ်ကြိုက်ဂဏန်းပိတ်ရန် - Close Two Digit Dashboards</h5>
        ...
        <div class="modal-dialog mt-lg-10">
         <div class="modal-content">
          ...
          <div class="modal-body">
           ...
           <form class="multisteps-form__form" action="{{ route('admin.two-digit-close.store') }}" method="post">
            @csrf
    ...
    <table class="table table-flush" id="permission-search">
     ...
     <tbody>
      ...
      <tr>
       ...
       <td>
        <form class="d-inline" action="{{ route('admin.two-digit-close.destroy', $digit->id) }}" method="POST">
         @csrf
         @method('DELETE')
